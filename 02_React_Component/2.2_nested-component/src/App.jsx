...
function App () {
  return (
    <>
      <h3>Portfolio of an Employee of our company.</h3>
      <Profile/> 
    </>
  )
}

// <h3></h3> is an HTML tag and always start with small letter.
// <Profile/> is a react Component and always start with capital letter.
